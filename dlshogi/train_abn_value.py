...
def main(*argv):
    ...
    def test(model):
        ...
        with torch.no_grad():
            for x1, x2, t1, t2, value in test_dataloader:
                ...
                loss = (1 - args.val_lambda) * loss2 + args.val_lambda * loss3 #+ loss1 
    ...
    for e in range(args.epoch):
        ...
        for x1, x2, t1, t2, value in train_dataloader:
            ...
            with torch.cuda.amp.autocast(enabled=args.use_amp):
                ...
                loss2 = bce_with_logits_loss(y2, t2)
                loss3 = bce_with_logits_loss(y2, value)
                # att_loss1 = F.cross_entropy(a1, t1)
                att_loss2 = F.cross_entropy(a2, t2)
                loss = (1 - args.val_lambda) * loss2 + args.val_lambda * loss3 + att_loss2 # + loss1 + att_loss1
            ...
            if t % eval_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    logging.info('epoch = {}, steps = {}, train loss = {:.07f}, {:.07f}, {:.07f}, test loss = {:.07f}, {:.07f}, {:.07f}, test accuracy = {:.07f}'.format(
                        epoch, t,
                        sum_loss2 / steps, sum_loss3 / steps, sum_loss / steps,
        ...
        test_loss2, test_loss3, test_loss, test_accuracy2, test_entropy2 = test(model)

        logging.info('epoch = {}, steps = {}, train loss avr = {:.07f}, {:.07f}, {:.07f}, test loss = {:.07f}, {:.07f}, {:.07f}, test accuracy = {:.07f}, test entropy = {:.07f}'.format(
            epoch, t,
            sum_loss2_epoch / steps_epoch, sum_loss3_epoch / steps_epoch, sum_loss_epoch / steps_epoch,
            test_loss2, test_loss3, test_loss,
            test_accuracy2,
            test_entropy2))
    ...
    if args.model:
        if args.use_swa and epoch >= args.swa_start_epoch:
            ...
            test_loss2, test_loss3, test_loss, test_accuracy2, test_entropy2 = test(swa_model)

            logging.info('epoch = {}, steps = {}, swa test loss = {:.07f}, {:.07f}, {:.07f}, swa test accuracy = {:.07f}, swa test entropy =  {:.07f}'.format(
                epoch, t,
                test_loss2, test_loss3, test_loss,
                test_accuracy2,
                test_entropy2))
