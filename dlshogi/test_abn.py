...
# from dlshogi.network import policy_value_network_resnet10_swish_att
...
if args.network == 'resnet10_swish':
    from dlshogi.network.policy_value_network_resnet10_swish_att import *
    nw = "ABN"
else:
    from dlshogi.network.policy_value_network import *
